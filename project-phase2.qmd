...
This OECD dataset provides indicators on exposure to wildfires in large regions. This indicator is derive from the European Joint Research Centre Global wildfire dataset, which captures fire activity and behaviour.It is measured as the percentage of the region's area exposed to wildfire. 
...
All of theses datasets come from the OECD website
